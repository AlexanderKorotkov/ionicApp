 ...
 * as custom events that can be used in an www.
 *
...
(function(window, document, ionic) {
   ...
   * various other information such as what kind of platform the www is currently installed on.
   *
   * @usage
   * ```js
   ...
   *
   *   ionic.Platform.exitApp(); // stops the www
   * });
   * ```
   */
  var self = ionic.Platform = {
     ...
     * When the www is within a WebView (Cordova), it'll fire
     * the callback once the device is ready. If the www is within
     ...
     * @description
     * Sets whether the www is fullscreen or not (in Cordova).
     * @param {boolean=} showFullScreen Whether or not to set the www to fullscreen. Defaults to true. Requires `cordova plugin add org.apache.cordova.statusbar`
 ...
 * - Multiple [unit tests](https://github.com/driftyco/ionic/blob/master/session/unit/utils/tap.unit.js) for each scenario
 *
 */
/*
 ...
 *
 * ### Android Notes
 * - If your www is running in fullscreen, i.e. you have
 *   `<preference name="Fullscreen" value="true" />` in your `config.xml` file
 *   you will need to set `ionic.Platform.isFullScreen = true` manually.
 *
 * - You can configure the behavior of the web view when the keyboard shows by setting
 *   [android:windowSoftInputMode](http://developer.android.com/reference/android/R.attr.html#windowSoftInputMode)
 *   to either `adjustPan`, `adjustResize` or `adjustNothing` in your www's
 ...
 *
 * ### iOS Notes
 * - If the content of your www (including the header) is being pushed up and
...
function keyboardFocusIn(e) {
  ...
  if (!scrollView.classList.contains("overflow-scroll")) {
    ...
    // could touchmove and cause some ugly changes to the www, so disable
...
ionic.Platform.ready(function() {
  ...
  // if orientation changes while www is in background, update on resuming
  /*
  if ( ionic.Platform.isWebView() ) {
  ...
  initialize: function (options) {
    ...
    var events = {
      ...
      touchmove: function(event) {
        ...
        // determine if scrolling session has run - one time session
...
(function () {
    ...
    var Swiper = function (container, params, _scope, $compile) {
        ...
        var defaults = {
            ...
            // To support iOS's swipe-to-go-back gesture (when being used in-www, with UIWebView).
        ...
        s.onTouchStart = function (e) {
            ...
            // Do NOT start if iOS edge swipe is detected. Otherwise iOS www (UIWebView) cannot swipe-to-go-back anymore
